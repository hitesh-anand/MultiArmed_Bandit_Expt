...
for i in range(4):
    ...
    plt.subplot(2, 2, i+1)
    if i==0:
        plt.title("Average Rewards after each Trial (in IOWA)")
    elif i==1:
        plt.title("Average Rewards after each Trial (in Equal Means)")
    elif i==2:
        plt.title("Average Rewards after each Trial (in Low Var)")
    elif i==3:
        plt.title("Average Rewards after each Trial (in High Var)")
