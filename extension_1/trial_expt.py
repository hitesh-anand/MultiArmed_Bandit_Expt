...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\anand\\Desktop\\Academics\\BSE662\\extension_1\\banditext1\\untitled.py',
...
uIntrotext = visual.TextStim(win=win, name='uIntrotext',
    text='Welcome!\n\nIn this part of the task you are initially awarded 10000. You will have unlimited time to select an option (Q/W/O/P). Each option corresponds to a penalty which will be deducted from your initial award.\n\nYour goal is to maximize your final award by minimising the penalties.\n\nPress\xa0SPACE\xa0to\xa0begin',
    font='Open Sans',
...
utrials = data.TrialHandler(nReps=40.0, method='random', 
...
#    uprize=max(uprize,0)
    ...
    if(ucntrnd%2==0):
        ...
        file.write(str(expInfo['Roll Number'])+", "+conditions[str(urndtype)]+", "+str(ucntrnd)+", "+str(round(tot_uprize,0))+", "+str(urep_choices)+"\n")
        file.close()
    ...
    if(ucntrnd==5):
        ...
        if(urndtype==2):#equalmeans
            uprize_lst=[ (0,3.16), (0,6.32), (0,8.37), (0,10)]
