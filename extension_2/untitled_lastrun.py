...
newprize_lst=[(-10,10),(-10,100),(10,10),(10,100)]
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hp\\OneDrive\\Desktop\\banditext2\\untitled_lastrun.py',
...
newtrials = data.TrialHandler(nReps=400.0, method='random', 
...
for thisNewtrial in newtrials:
    ...
    if newkeyresp.keys=='q':
        newprize=random.gauss(newprize_lst[0][0],newprize_lst[0][1])
        newprize+=30 + (random.random() * (30))
    elif newkeyresp.keys=='w':
        newprize=random.gauss(newprize_lst[1][0],newprize_lst[1][1])
        newprize+=30 + (random.random() * (30))
    elif newkeyresp.keys=='o':
        newprize=random.gauss(newprize_lst[2][0],newprize_lst[2][1])
        newprize+=30 + (random.random() * (30))
    elif newkeyresp.keys=='p':
        newrize=random.gauss(newprize_lst[3][0],newprize_lst[3][1])
        newprize+=30 + (random.random() * (30))
    else:
        newprize=0
